...
8. ✅ **تحكم في موضع النص والباركود (Y)**
9. ✅ **تحكم في حرارة الطابعة (0-15)**
10. ✅ حفظ/تحميل الإعدادات تلقائياً (settings.json)
11. ✅ طباعة اختبار (رقمين: 999 و 1000)
12. ✅ **طباعة رقمين فوق بعض في كل ورقة**
...
### موضع النص (Y)
- قيمة موجبة (+) = تحريك النص للأسفل
- قيمة سالبة (-) = تحريك النص للأعلى
- القيمة الافتراضية: 0

### موضع الباركود (Y)
- قيمة موجبة (+) = تحريك الباركود للأسفل
- قيمة سالبة (-) = تحريك الباركود للأعلى
- القيمة الافتراضية: 0

### حرارة الطابعة (Density)
- النطاق: 0 إلى 15
- 0 = أخف (حبر خفيف)
- 15 = أغمق (حبر كثيف)
...
- 2025-11-07: إضافة خانات التحكم في موضع النص والباركود وحرارة الطابعة
